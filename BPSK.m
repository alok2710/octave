...
fc=input('Enter frequency of Carrier Sine wave: '); %30
fm=input('Enter Message frequency : '); %3
amp=input('Enter Carrier & Message Amplitude(Assuming Both Equal):'); %1
