...
fc1=input('Enter the freq of 1st Sine Wave carrier:'); %20
fc2=input('Enter the freq of 2nd Sine Wave carrier:'); %40
fp=input('Enter the freq of Periodic Binary pulse (Message):'); %3
amp=input('Enter the amplitude (For Both Carrier & Binary Pulse Message):'); %1 
amp=amp/2;
